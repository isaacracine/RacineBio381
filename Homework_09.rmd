...
Below I will demonstrate structured programming. My functions are in a [source script](.\hw9_source.html). I also answered question 3 in this part by recording several trials in one data frame. The plot is only for the final simulated sample.
...
Here I will demonstrate changing the program or answering problem 2. I wrote functions to simulate gamma distribution random data. I also created a function that plots the mean of each treatment and their 95% confidence interval.
```{r}
#-------------- Question 2 ---------------
