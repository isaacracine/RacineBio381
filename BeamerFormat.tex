...
% TITLE PAGE DATA--------------------------
\title[Practice]{My First Practice Presentation} % The short title appears at the bottom of every slide, the full title is only on the title page
...
\date{10 Feb 2021} % Date, can be changed to a custom date or \today
% -----------------------------------------
...
\end{alltt}
\begin{verbatim}
##  [1] 0.451908222 0.444399468 0.498535858 0.597796603 0.518321256 0.117600980
##  [7] 0.281020182 0.008983333 0.296914636 0.955612025
\end{verbatim}
\end{kframe}
\end{knitrout}
